 ...
 */
public class EmailReceiveImap {

    public static void receive(EmailUserInfo emailUser, List<EmailReceiveEmailInfo> listReceiveEmailinfo, List<MimeMessage> listReceiveEmailMsg) throws MessagingException, IOException {
        ...
        final String PROTOCAL_IMAP = "imap";
        final String HOST_IMAP = "imap.yeah.net";
        final int PORT = 993;
        ...
        URLName urln = new URLName(PROTOCAL_IMAP, HOST_IMAP, PORT, null,
