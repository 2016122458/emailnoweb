...
function redraw_dashboard_analytics(){
  ...
  jQuery.ajax({   
        ...
        complete: function(XMLHttpRequest, textStatus) {
            this; // AJAXoptions
            //alert("complete textStatus:"+textStatus);//error   success
            ...
            Morris.Area({
				  ...
				  labels: ['Y', 'Z']
				   ...
				   // init Morris
				    ...
				    element: 'barchart',
				    data: [
				      {x: '2012-01-01', y: 102, z:100,p:109},
				      {x: '2012-01-10', y: 172, z:150,p:109},
				      {x: '2012-01-20', y: 130, z:110,p:109},
				      {x: '2012-02-01', y: 198, z:180,p:109},
				      {x: '2012-02-10', y: 256, z:220,p:109},
				      {x: '2012-02-20', y: 211, z:200,p:109},
				      {x: '2012-03-01', y: 345, z:320,p:109},
				      {x: '2012-03-10', y: 456, z:400,p:109},
				      {x: '2012-03-20', y: 384, z:300,p:109},
				      {x: '2012-04-01', y: 584, z:500,p:109}
				    ],
				    xkey: 'x',
				    ykeys: ['y', 'z','p'],
				    barColors: ['#42C1F7','#B3E6FC','#BAF5F5'],
				    labels: ['Y', 'Z','P']
